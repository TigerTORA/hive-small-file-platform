...
def upgrade() -> None:
    ...
    op.add_column(
        "clusters", sa.Column("archive_root_path", sa.String(length=500), nullable=True)
    )
    op.add_column(
        "clusters", sa.Column("cold_data_threshold_days", sa.Integer(), nullable=True)
    )
    op.add_column(
        "clusters", sa.Column("auto_archive_enabled", sa.Boolean(), nullable=True)
    )
    op.add_column(
        "clusters",
        sa.Column("archive_compression_enabled", sa.Boolean(), nullable=True),
    )
