...
def upgrade() -> None:
    ...
    op.add_column('task_logs', sa.Column('yarn_application_id', sa.String(length=100), nullable=True))
    op.add_column('task_logs', sa.Column('progress_percentage', sa.Float(), nullable=True))
