...
def upgrade() -> None:
    ...
    op.create_table('table_metrics_new',
    ...
    # Recreate indexes
    op.create_index(op.f('ix_table_metrics_cluster_id'), 'table_metrics', ['cluster_id'], unique=False)
    op.create_index(op.f('ix_table_metrics_database_name'), 'table_metrics', ['database_name'], unique=False)
    op.create_index(op.f('ix_table_metrics_table_name'), 'table_metrics', ['table_name'], unique=False)
    op.create_index(op.f('ix_table_metrics_scan_time'), 'table_metrics', ['scan_time'], unique=False)
