...
class TestCompleteWorkflowScenarios:
    ...
    def test_cluster_discovery_workflow(self, client):
        ...
        if len(clusters) > 0:
            ...
            summary_response = client.get(f"/api/v1/tables/small-files?cluster_id={cluster_id}")
            ...
            metrics_response = client.get(f"/api/v1/tables/metrics?cluster_id={cluster_id}")
    ...
    def test_data_consistency_workflow(self, client):
        ...
        for cluster in clusters:
            ...
            cluster_tasks_response = client.get(f"/api/v1/tasks/?cluster_id={cluster_id}")
    ...
    def test_end_to_end_scenario(self, client):
        ...
        if len(clusters) > 0:
            ...
            analysis_response = client.get(f"/api/v1/tables/small-file-analysis/{cluster_id}")
