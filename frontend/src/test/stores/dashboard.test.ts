...
describe('Dashboard Store', () => {
  ...
  describe('loadSummary', () => {
    ...
    it('should handle summary loading error', async () => {
      ...
      vi.mocked(dashboardApi.getSummary).mockRejectedValue(new Error(errorMessage))
  ...
  describe('loadTrends', () => {
    ...
    it('should handle trends loading error', async () => {
      ...
      vi.mocked(dashboardApi.getTrends).mockRejectedValue(new Error(errorMessage))
  ...
  describe('reset', () => {
    it('should reset all state to initial values', () => {
      ...
      store.trends = [{ date: '2023-12-01', total_files: 1000, small_files: 300, ratio: 30.0 }]
