    ...
    <div class="flow-header">
      ...
      <div class="flow-summary">
        <span class="summary-text"
          >实时监控您的数据从活跃使用到归档存储的完整生命周期</span
        >
      </div>
    </div>
      ...
      <div class="pipeline-stages">
        ...
        >
          ...
          >
            ...
            <!-- 状态指示器 -->
            <div class="stage-status" v-if="stage.status">
              <div class="status-dot" :class="stage.status.type"></div>
          ...
          >
            ...
            <div class="connector-label" v-if="stage.transitionInfo">
