    ...
    <div class="panel-content">
      ...
      <el-card class="config-section" shadow="never">
        ...
        <div class="config-actions">
          ...
          <el-button @click="showImportDialog = true" :icon="Upload" size="small">
            导入配置
          </el-button>
          <el-button @click="resetConfig" :icon="RefreshLeft" size="small" type="warning">
            重置配置
          </el-button>
        </div>
        ...
        <div class="current-config">
          <el-text size="small" type="info">
            当前配置：{{ Object.keys(enabledFeatures).length }} / {{ Object.keys(features).length }} 个功能启用
          </el-text>
        </div>
      </el-card>
    </div>
...
import { FeatureManager, type FeatureFlags, presetConfigs } from '@/utils/feature-flags'
...
// 特性配置信息
const featureConfigs: Record<keyof FeatureFlags, {
  name: string
  description: string
  disabled?: boolean
}> = {
