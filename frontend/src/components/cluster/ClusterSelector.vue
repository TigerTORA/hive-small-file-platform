<template>
  <div class="cluster-selector">
    <div class="selector-header">
      ...
      <p class="selector-subtitle">请选择要监控的 Hive 集群，查看详细的数据生命周期管理信息</p>
    </div>
      ...
      >
        <div class="cluster-info">
          ...
          <div class="cluster-meta">
            <span class="cluster-type">{{ getClusterTypeText(cluster.cluster_type) }}</span>
            <el-tag
          ...
          <div class="cluster-details">
            <div class="detail-item">
              ...
              <span class="detail-value">{{ cluster.hive_host }}:{{ cluster.hive_port }}</span>
            </div>
            <div class="detail-item">
              <span class="detail-label">数据库:</span>
              <span class="detail-value">{{ clusterStats[cluster.id]?.databases || 0 }} 个</span>
            </div>
          </div>
        </div>
