<template>
  <div class="cluster-list">
    ...
    <div
      v-if="redirectUrl"
      class="cluster-selection-notice"
    >
      <div class="notice-content">
        <el-icon class="notice-icon"><Monitor /></el-icon>
        <div class="notice-text">
          <h4>请选择要使用的集群</h4>
          <p>您需要先选择一个集群才能访问监控功能。点击任意集群卡片即可选择并继续。</p>
        </div>
      </div>
    </div>
          ...
          <div class="cluster-title-section">
            <div class="cluster-name-row">
              ...
              <ConnectionStatusIndicator
                ...
                @test-connection="service => $emit('test-specific-connection', cluster.id, service)"
              />
            </div>
...
<script setup lang="ts">
  ...
  import { Monitor, Right, Connection, Edit, Delete, MoreFilled } from '@element-plus/icons-vue'
