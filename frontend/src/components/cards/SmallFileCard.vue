<template>
  <el-card class="small-file-card" shadow="hover">
    <template #header>
      <div class="card-header">
        ...
        <div class="header-right">
          <el-tag :type="alertType" size="small" effect="dark">
            <el-icon :size="12">
    ...
    <div class="card-content">
      <div class="problem-overview">
        <div class="severity-indicator">
          <div class="severity-chart">
            <div class="chart-ring" :style="ringStyle">
      ...
      <div class="impact-analysis" v-if="showImpact">
      ...
      <div class="optimization-suggestions" v-if="showSuggestions">
